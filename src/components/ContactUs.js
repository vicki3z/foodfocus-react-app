...
const ContactUs = () => {
  return (
    <>
      <Helmet>
        <meta charset="UTF-8" />
        <title>Contact Us - Food Focus Thailand | Be Media Focus</title>
        <meta property="og:title" content="Contact Us - Food Focus Thailand | Be Media Focus" />
        ...
        <meta property="og:url" content="https://www.foodfocusthailand.com/contact-us" />
